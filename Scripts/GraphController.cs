   ...
   // public Text DairyButtonText;
    ...
    public void Begin()
    {
        ...
        Apple_pie.DataSource.SetValue("Front", Simulation.totalOnShelves["Apples"]);
            ...
            //disable one of the two graphs
                //Banana_pie.transform.localScale = new Vector3(0, 0, 0);
        ...
        //disable one of the two graphs
        //Cereal_pie.transform.localScale = new Vector3(0, 0, 0);
        ...
        //Frozen
            ...
            //disable one of the two graphs
                //Dessert_pie.transform.localScale = new Vector3(0, 0, 0);
        ...
        //Dairy
            ...
            //disable one of the two graphs
                //Cheese_pie.transform.localScale = new Vector3(0, 0, 0);
